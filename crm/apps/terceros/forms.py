...
class TerceroForm(forms.ModelForm):
    class Meta:
        model = Tercero
        fields = ["tipo_tercero", "tipo", "nombre", "nombre_juridico", "direccion", "rif", "telefono", "email", 'web', "tipocapital", "ciudad", "zona", "descripcion_actividad", "tamano_empresa", "tipo_empresa", "vendedor"]
        labels = {
